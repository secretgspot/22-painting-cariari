...
<article id="privacy">
  ...
  <section id="section--privacy-policy">
    <div class="main-content">
      ...
      <p>Effective date: October 01, 2021</p>

      <p>{$siteSettings.company} ("us", "we", or "our") operates the {$page.host} website (hereinafter referred to as the "Service").</p>

      <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.</p>

      <p>We use data you provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions.</p>

      <div class="grouped">
        <h3>Definitions</h3>
        <ul>
          <li>
            <p><strong>Service</strong> Service is the {$page.host} website operated by {$siteSettings.company}</p>
          </li>
          <li>
      ...
      <div class="grouped">
        ...
        <p>{$siteSettings.company} may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of {$siteSettings.company}</li>
      ...
      <!-- <div class="grouped">
        ...
        <ul>
          <li>By email: {$siteSettings.email}</li>
          <li>By phone number: {$siteSettings.phone}</li>
        </ul>
      </div> -->
			...
			<p>Last updated: April 21, 2019</p>
			<p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the {$page.host} website (the "Service") operated by {$siteSettings.company} ("us", "we", or "our").</p>
			<p>Your access to and use of the Service is conditioned on your acceptance of and compliance with these Terms. These Terms apply to all visitors, users and others who access or use the Service.</p>
			<p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of the terms then you may not access the Service.</p>

			<div class="grouped">
				<h3>Links To Other Web Sites</h3>
				<p>Our Service may contain links to third-party web sites or services that are not owned or controlled by {$siteSettings.company}.</p>
				<p>{$siteSettings.company} has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that {$siteSettings.company} shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.</p>
